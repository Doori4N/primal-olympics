...
import {CameraAnimation} from "../trackAndFieldGame/components/CameraAnimation";
...
import {CameraMovement} from "../trackAndFieldGame/components/CameraMovement";
...
export class HurdleDashScene extends Scene {
    constructor() {
        super("Raptor Escape");
    }
    ...
    public async preload(): Promise<void> {
        ...
        this.loadedAssets["raptor"] = await B.SceneLoader.LoadAssetContainerAsync("meshes/models/", "velociraptor.glb", this.babylonScene);
    ...
    private _createGameManagerEntity(): Entity {
        ...
        const description: string = `
            <span class='description-title'>Get ready for a race where every jump counts!</span></span><br>
            <ul>
                <li>Jump over hurdles by pressing the button at the right time and with the right pressure.</li>
                <li>Reach the finish line before the raptors catches you!</li>
            </ul>
        `;
        const imgSrc: string = "hurdle-dash-presentation.png";
